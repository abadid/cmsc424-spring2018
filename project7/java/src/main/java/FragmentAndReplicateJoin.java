...
public class FragmentAndReplicateJoin {
     ...
     */
    private static JavaRDD<Tuple4<String, Double, String, Double>> fragmentAndReplicateJoin(JavaRDD<Tuple2<String, Double>> leftRelation, int n, JavaRDD<Tuple2<String, Double>> rightRelation, int m) {
        return null;
    }
