...
public class Tasks {
    ...
    public static JavaPairRDD<String, Tuple2<String, Integer>> task1(JavaRDD<String> playLines) {
        return null;
    }

    public static JavaRDD<String> task2(JavaRDD<JSONObject> jsonObjects) {
        return null;
    }

    public static JavaPairRDD<String, List<String>> task3(JavaRDD<JSONObject> jsonObjects) {
        return null;
    }
