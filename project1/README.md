...
be the score output by the program. The program tries to give partial credits (as you can see in the code). In general, it is unlikely that your score on the larger, hidden 
